...
*Note: the NEMA stepper motors can be used as both unipolar or bipolar stepper motors. By adding connections to the tap pins, you can convert them to unipolar mode.
